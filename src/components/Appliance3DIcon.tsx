...
function WashingMachine3D() {
  return (
    <svg viewBox="0 0 48 48" className="h-full w-full" aria-hidden="true">
      ...
      {SHADOW}
      <rect x="8" y="5" width="32" height="38" rx="9" fill="url(#wm-body)" stroke="#5f86c4" strokeWidth="1.25" />
      <rect x="8" y="5" width="32" height="11" rx="9" fill="#ffffff" opacity="0.35" />
      <circle cx="14" cy="11" r="1.6" fill="#446fad" />
      <rect x="19" y="9.5" width="15" height="3" rx="1.5" fill="#9eb9dd" />
      <circle cx="24" cy="28" r="11" fill="#9fbbe2" />
      <circle cx="24" cy="28" r="8.6" fill="url(#wm-glass)" stroke="#4777bd" strokeWidth="1" />
...
function Refrigerator3D() {
  return (
    <svg viewBox="0 0 48 48" className="h-full w-full" aria-hidden="true">
      ...
      {SHADOW}
      <rect x="12" y="3" width="24" height="41" rx="6" fill="url(#fr-body)" stroke="#6f8f92" strokeWidth="1.25" />
      <rect x="13.5" y="4.5" width="5" height="38" rx="3" fill="#ffffff" opacity="0.5" />
      <line x1="12" y1="21" x2="36" y2="21" stroke="#78989b" strokeWidth="1.6" />
      <rect x="30" y="9" width="2.4" height="8" rx="1.2" fill="#5f7f82" />
      <rect x="30" y="25" width="2.4" height="11" rx="1.2" fill="#5f7f82" />
    </svg>
  );
}
...
function AirConditioner3D() {
  return (
    <svg viewBox="0 0 48 48" className="h-full w-full" aria-hidden="true">
      ...
      {SHADOW}
      <rect x="5" y="13" width="38" height="18" rx="6" fill="url(#ac-body)" stroke="#54acd3" strokeWidth="1.25" />
      <rect x="6.5" y="14.5" width="35" height="6" rx="4" fill="#ffffff" opacity="0.5" />
      <line x1="10" y1="25" x2="38" y2="25" stroke="#65b9dc" strokeWidth="1.8" strokeLinecap="round" />
      <line x1="10" y1="28" x2="38" y2="28" stroke="#65b9dc" strokeWidth="1.8" strokeLinecap="round" />
      <circle cx="37" cy="18" r="1.4" fill="#209bd0" />
      <path d="M20 35 q3 4 6 0" stroke="#36b2df" strokeWidth="1.8" fill="none" strokeLinecap="round" opacity="0.9" />
      <path d="M28 35 q3 4 6 0" stroke="#36b2df" strokeWidth="1.8" fill="none" strokeLinecap="round" opacity="0.75" />
    </svg>
  );
}
...
function Microwave3D() {
  return (
    <svg viewBox="0 0 48 48" className="h-full w-full" aria-hidden="true">
      ...
      {SHADOW}
      <rect x="4" y="12" width="40" height="24" rx="5" fill="url(#mw-body)" stroke="#7e879b" strokeWidth="1.25" />
      <rect x="4" y="12" width="40" height="7" rx="5" fill="#ffffff" opacity="0.35" />
      <rect x="8" y="16" width="22" height="16" rx="3" fill="url(#mw-glass)" stroke="#596170" strokeWidth="1" />
      <path d="M10 18 l6 6" stroke="#ffffff" strokeWidth="1.2" opacity="0.18" />
      <rect x="33" y="17" width="7" height="2.4" rx="1.2" fill="#697184" />
      <circle cx="34.5" cy="23" r="1.3" fill="#767f94" />
      <circle cx="38.5" cy="23" r="1.3" fill="#767f94" />
      <rect x="33" y="28" width="7" height="3" rx="1.5" fill="#c53f1e" />
    </svg>
  );
}
...
function Tv3D() {
  return (
    <svg viewBox="0 0 48 48" className="h-full w-full" aria-hidden="true">
      ...
      {SHADOW}
      <rect x="5" y="8" width="38" height="26" rx="4" fill="#171c25" />
      <rect x="7" y="10" width="34" height="22" rx="2.5" fill="url(#tv-screen)" />
      <path d="M10 30 L26 11 L31 11 L13 30 Z" fill="#ffffff" opacity="0.08" />
      <rect x="20" y="34" width="8" height="5" fill="#242b38" />
      <rect x="14" y="39" width="20" height="2.6" rx="1.3" fill="#313949" />
    </svg>
  );
}
...
function AirPurifier3D() {
  return (
    <svg viewBox="0 0 48 48" className="h-full w-full" aria-hidden="true">
      ...
      {SHADOW}
      <rect x="15" y="4" width="18" height="39" rx="9" fill="url(#ap-body)" stroke="#7f93a8" strokeWidth="1.25" />
      <rect x="16.5" y="6" width="4" height="35" rx="2" fill="#ffffff" opacity="0.55" />
      <rect x="20" y="7.5" width="8" height="2.2" rx="1.1" fill="#8fa1b4" />
      <circle cx="24" cy="25" r="7.5" fill="#e4ecf5" stroke="#8398ac" strokeWidth="1.1" />
      <circle cx="24" cy="25" r="5.2" fill="none" stroke="#90a3b8" strokeWidth="1.2" />
      <circle cx="24" cy="25" r="2.8" fill="none" stroke="#90a3b8" strokeWidth="1.2" />
      <circle cx="24" cy="25" r="1.2" fill="#5d7288" />
      <circle cx="24" cy="37.5" r="1.6" fill="#10a86b" />
    </svg>
  );
}
